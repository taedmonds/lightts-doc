...
<LinkCard title="Explore All CLI Commands" href="../" description="Discover more ways to use the `lts` CLI." />
...
<LinkCard title="Add Features" href="../add/" description="Extend your project with JWT, validation, and more." />