...
<div class="card-container">
  <Card title="JWT Authentication" icon="seti:lock">
    ...
    <LinkCard title="Add JWT" href="../../features/jwt/" description="Secure routes with JWTs." />
  </Card>
  ...
  <Card title="Validation" icon="seti:json">
    ...
    <LinkCard title="Add Validation" href="../../features/validation/" description="Validate inputs with Joi." />
  </Card>

  <Card title="CORS" icon="approve-check">
    ...
    <LinkCard title="Add CORS" href="../../features/cors/" description="Enable CORS support." />
  </Card>
  ...
  <Card title="Database" icon="seti:db">
    ...
    <LinkCard title="Add Database" href="../../features/database/" description="Connect to your database." />
  </Card>
</div>
